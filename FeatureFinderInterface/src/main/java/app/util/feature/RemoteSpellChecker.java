...
@Component
public class RemoteSpellChecker {
	private static String URL_PROPERTY_FILE="serverurls.properties";
    private static String SPELL_CHECKER="spellchecker";
	private ServiceLocator serviceLocator;
	private RestTemplate restTemplate;
    
	public RemoteSpellChecker() {
	}
	...
	public String checkText(String text, String language) {	
